...
export const ImageStack = () => {
  return (
    <div className="relative w-full">
      ...
      <div className="flex items-end gap-x-4 lg:gap-x-10 absolute -bottom-[20%] right-0 z-10 text-white/10 inset-y-0 -mr-[20%] w-full">
